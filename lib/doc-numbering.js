...
export const DOC_PREFIXES = {
  ...
  PTW: 'PTW',   // Putaway Document (header + lines)
...
export const nextPutawayDocNumber = (warehouseCode, tx) => nextDocNumber({ prefix: DOC_PREFIXES.PTW, warehouseCode, tx })
...
export const nextStockOpnameNumber = (warehouseCode, tx) => nextDocNumber({ prefix: DOC_PREFIXES.SO, warehouseCode, tx })
