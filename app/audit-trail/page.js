...
const MODULES = ['ALL', 'AUTH', 'MASTER_ITEM', 'MASTER_CATEGORY', 'MASTER_UOM', 'LOCATION', 'RECEIVING', 'PUTAWAY', 'MOVEMENT', 'ADJUSTMENT', 'CYCLE_COUNT', 'PICKING', 'PACKING', 'SHIPPING', 'STOCK_OPNAME', 'IMPORT_ITEM_MASTER']
const ACTIONS = ['ALL', 'CREATE', 'UPDATE', 'DELETE', 'POST', 'APPROVE', 'REJECT', 'IMPORT', 'LOGIN', 'LOGOUT']
